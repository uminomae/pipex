...
/*   Updated: 2022/09/14 15:10:33 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 				t_pipex *pipex, int pipe[2], int pipe_n_fd[2], int add_pipe);
static pid_t	run_child_multi(\
...
// static pid_t	run_child_multi(
// 				t_pipex *pipex, int prev_pipe[2], int pipe[2], int add_pipe)
static pid_t	run_child_multi(\
				t_pipex *pipex, int *prev_pipe, int *pipe, int add_pipe)
{
	...
	// x_close(pipex, pipe[WRITE]);
	// x_close(pipex, 1);
	// x_close(pipex, 0);
	// x_close(pipex, pipe[READ]);
